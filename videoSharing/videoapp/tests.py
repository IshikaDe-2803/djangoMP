...
class TrendingPageTests(TestCase):
    ...
    def test_template_name_correct(self):  
        response = self.client.get(reverse("trending"))
        self.assertTemplateUsed(response, "videoapp/trending.html")
...
class HomePageTests(TestCase):
    ...
    def test_template_name_correct(self):  
        response = self.client.get(reverse("homepage"))
        self.assertTemplateUsed(response, "videoapp/homepage.html")
...
class UploadPageTests(TestCase):
    ...
    def test_template_name_correct(self):  
        self.client.login(username='john', password='johnpassword')
        response = self.client.get(reverse("UploadVideo"))
        self.assertTemplateUsed(response, "videoapp/upload.html")
